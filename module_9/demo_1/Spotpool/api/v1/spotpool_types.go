...
type SpotpoolSpec struct {
	...
	AvaliableZone      string   `json:"AvaliableZone,omitempty"`
...
type SpotpoolStatus struct {
	...
	// conditions represent the current state of the Spotpool resource.
...
type Spotpool struct {
	...
	// spec defines the desired state of Spotpool
	// +required
	Spec SpotpoolSpec `json:"spec"`

	// status defines the observed state of Spotpool
	// +optional
	Status SpotpoolStatus `json:"status,omitzero"`
}
